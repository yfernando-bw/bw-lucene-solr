...
public class UpdateShardHandlerConfig {
  ...
  public static final UpdateShardHandlerConfig DEFAULT
      = new UpdateShardHandlerConfig(DEFAULT_MAXUPDATECONNECTIONS, DEFAULT_MAXUPDATECONNECTIONSPERHOST,
                                     DEFAULT_DISTRIBUPDATESOTIMEOUT, DEFAULT_DISTRIBUPDATECONNTIMEOUT,
                                      ...
                                      DEFAULT_MAXRECOVERYTHREADS, DEFAULT_METRICNAMESTRATEGY);
  ...
  public UpdateShardHandlerConfig(int maxUpdateConnections, int maxUpdateConnectionsPerHost, int distributedSocketTimeout, int distributedConnectionTimeout, int updateConnectionsEvictorSleepDelay, int maxUpdateConnectionIdleTime, int maxRecoveryThreads, String metricNameStrategy) {
